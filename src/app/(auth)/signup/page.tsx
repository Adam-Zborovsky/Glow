        ...
        <div className="max-w-sm w-full space-y-8">
          <div className="flex flex-col gap-2">
            <div className="flex gap-4 text-sm font-semibold border-b border-slate-100 mb-6">
              <Link href="/signup" className="pb-4 text-slate-900 border-b-2 border-primary">Sign Up</Link>
              <Link href="/login" className="pb-4 text-slate-400 hover:text-slate-600 transition-colors">Log In</Link>
            </div>
          ...
          <p className="text-center text-xs text-slate-400">
            By signing up you agree to our <Link href="#" className="text-primary hover:underline font-medium">Terms of Service</Link> and <Link href="#" className="text-primary hover:underline font-medium">Privacy Policy</Link>.
          </p>
        </div>
      </div>
    </div>
